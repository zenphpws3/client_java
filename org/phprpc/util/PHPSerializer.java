...
package com.dogstar.shakenext.apiclient.org.phprpc.util;
...
public final class PHPSerializer {
    ...
    private int writeObject(ByteArrayOutputStream stream, Object obj, HashMap ht, int hv) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (obj instanceof com.dogstar.shakenext.apiclient.org.phprpc.util.Serializable) {
            byte[] cs = ((com.dogstar.shakenext.apiclient.org.phprpc.util.Serializable) obj).serialize();
    ...
    private Object readCustomObject(ByteArrayInputStream stream, ArrayList objectContainer) {
        ...
        else if (o instanceof com.dogstar.shakenext.apiclient.org.phprpc.util.Serializable) {
            byte[] b = new byte[n];
            stream.read(b, 0, n);
            ((com.dogstar.shakenext.apiclient.org.phprpc.util.Serializable) o).unserialize(b);
        }
        else {
            stream.skip(n);
        }
